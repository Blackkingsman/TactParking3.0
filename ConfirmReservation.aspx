...
<body>
    ...
    <div id="parent">
        <form id="form1" runat="server" class="auto-style1">
            ...
            <asp:DropDownList runat="server" ID="DropDownList1" CssClass="auto-style2" DataSourceID="SqlDataSource1" DataTextField="timerange" DataValueField="timerange"></asp:DropDownList>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TactParkingDbConnectionString %>" SelectCommand="SELECT [timerange], [hour_id] FROM [HourParkingSpot] WHERE (([pid] = @pid) AND ([reserved] = @reserved) AND ([day_id] = @day_id))">
                <SelectParameters>
                    <asp:SessionParameter Name="pid" SessionField="PID" Type="Int32" />
                    <asp:Parameter DefaultValue="0" Name="reserved" Type="String" />
                    <asp:SessionParameter Name="day_id" SessionField="DayValue" Type="Int32" />
                </SelectParameters>
            </asp:SqlDataSource>
        </form>
    </div>
